...
if($_SERVER["REQUEST_METHOD"] == "get"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM logreg WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO logreg (username, password) VALUES (?, ?)";
...
<head>
    ...
    <style>
        ...
        #ukraine p{text-align:center; margin-top:30px; font-size:28px;}
    </style>
</head>
<body>
    
        <!-- <h2>Sign Up</h2>-->
      <div id="ukraine"> <p>  Please fill this form to create an account.</p> </div>
...
$(document).ready(function() {
  $("#first_form").validate({
    ...
    messages : {
      ...
      password:{
        required:"password must be empty"
      },
      Confirmpassword:{
